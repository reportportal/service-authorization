...
//                junit 'build/reports/**/*.xml'
        ...
        stage('Deploy to Dev Environment') {
            container('helm') {
                ...
                sh "helm upgrade -n reportportal --reuse-values --set uat.repository=$srvRepo --set uat.tag=$srvVersion --wait -f ./$ciDir/rp/values-ci.yml reportportal ./$k8sDir/reportportal/v5"
            }
        }
