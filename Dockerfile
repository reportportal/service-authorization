...
LABEL version="2.7.0-ALPHA-5"
LABEL description="EPAM Report portal. SSO Authorization Service"

RUN apk --no-cache add unzip

ENV APP_FILE service-authorization-2.7.0-ALPHA-5
ENV APP_DOWNLOAD_URL https://dl.bintray.com/epam/reportportal/com/epam/reportportal/service-authorization/2.7.0-ALPHA-5/$APP_FILE.zip
