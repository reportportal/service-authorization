...
LABEL version=${APP_VERSION} description="EPAM ReportPortal. jobs Service" maintainer="Andrei Varabyeu <andrei_varabyeu@epam.com>, Hleb Kanonik <hleb_kanonik@epam.com>"
