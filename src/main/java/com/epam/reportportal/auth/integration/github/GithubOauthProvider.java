...
public class GithubOauthProvider extends OAuthProvider {
	...
	public GithubOauthProvider(GitHubUserReplicator gitHubUserReplicator, AuthConfigService authConfigService) {
	...
	public ResourceServerTokenServices getTokenServices() {
		return new GitHubTokenServices(gitHubUserReplicator, authConfigService.getLoginDetailsSupplier(getName()));
	}
}
