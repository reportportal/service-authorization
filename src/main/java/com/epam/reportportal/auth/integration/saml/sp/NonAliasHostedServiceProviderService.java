...
public class NonAliasHostedServiceProviderService extends HostedServiceProviderService {
	...
	public NonAliasHostedServiceProviderService(LocalServiceProviderConfiguration configuration, ServiceProviderMetadata metadata,
	...
	public AuthenticationRequest authenticationRequest(IdentityProviderMetadata idp) {
		...
		AuthenticationRequest request = new AuthenticationRequest()
				...
				.setAssertionConsumerService(getPreferredEndpoint(sp.getServiceProvider().getAssertionConsumerService(), null, -1))
