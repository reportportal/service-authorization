 ...
 */
public class HostBasedSamlServiceProviderProvisioningExtension extends HostBasedSamlServiceProviderProvisioning {

	private final AuthenticationRequestEnhancer authenticationRequestEnhancer;

	public HostBasedSamlServiceProviderProvisioningExtension(SamlConfigurationRepository configuration, SamlTransformer transformer,
			SamlValidator validator, SamlMetadataCache cache, AuthenticationRequestEnhancer authnRequestEnhancer) {
