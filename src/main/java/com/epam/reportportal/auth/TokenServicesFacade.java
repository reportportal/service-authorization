...
public class TokenServicesFacade {
  ...
  @Autowired
  public TokenServicesFacade(
      @Qualifier(value = "databaseTokenServices") DefaultTokenServices databaseTokenServices,
      DefaultTokenServices jwtTokenServices, ClientDetailsService clientDetailsService,
  ...
  public OAuth2AccessToken createApiToken(ReportPortalClient client, String username,
      Authentication userAuthentication,
      Map<String, Serializable> extensionParams) {
    OAuth2Request oAuth2Request = createOAuth2Request(client, username, extensionParams);
    return databaseTokenServices.createAccessToken(
  ...
  private OAuth2Request createOAuth2Request(ReportPortalClient client, String username,
    ...
    OAuth2Request oAuth2Request = oAuth2RequestFactory.createOAuth2Request(clientDetails,
