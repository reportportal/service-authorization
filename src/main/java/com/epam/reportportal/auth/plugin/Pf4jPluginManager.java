...
public class Pf4jPluginManager extends AbstractIdleService implements Pf4jPluginBox {
	...
	public Pf4jPluginManager(String pluginsDir, String pluginsTempPath, String resourcesDir, PluginLoader pluginLoader,
			IntegrationTypeRepository integrationTypeRepository, PluginManager pluginManager) throws IOException {
	 ...
	 *
	 * @param fileName Name of the plugin file to put to the {@link com.epam.reportportal.auth.plugin.Pf4jPluginManager#uploadingPlugins}
	 * @param path     Full path to the plugin file
	 * @see com.epam.reportportal.auth.plugin.Pf4jPluginManager
	 */
	 ...
	 *
	 * @param fileName Name of the plugin file to remove from the {@link com.epam.reportportal.auth.plugin.Pf4jPluginManager#uploadingPlugins}
	 * @see com.epam.reportportal.auth.plugin.Pf4jPluginManager
	 */
