...
public class Suppliers {
  ...
  /**
   * Formatted supplier. Applies {@link MessageFormatter} to be able to pass formatted string with
   * parameters as we did int slf4j. Good approach to avoid string concatenation before we really
   * need it
   *
   * @param string     String to be supplied
